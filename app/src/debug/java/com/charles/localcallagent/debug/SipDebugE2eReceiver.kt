...
import com.charles.localcallagent.llm.litert.LiteRtLmGemmaModel
import com.charles.localcallagent.models.OnDeviceModelManager
import com.charles.localcallagent.telephony.api.RegistrationState
import com.charles.localcallagent.telephony.sip.SipAgentTransport
 ...
 * adb shell am broadcast -a com.charles.localcallagent.sip.DEBUG_SIP_E2E \
 *   -n com.charles.localcallagent.sip/com.charles.localcallagent.debug.SipDebugE2eReceiver \
...
class SipDebugE2eReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION = "com.charles.localcallagent.sip.DEBUG_SIP_E2E"
